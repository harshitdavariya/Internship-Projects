    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ConversationActivity.this, "Calliing...", Toast.LENGTH_SHORT).show();

                if (ActivityCompat.checkSelfPermission(ConversationActivity.this, Manifest.permission.CALL_PHONE)
                    != PackageManager.PERMISSION_GRANTED)  {

                    Toast.makeText(ConversationActivity.this, "Permission Not Granted...", Toast.LENGTH_SHORT).show();
